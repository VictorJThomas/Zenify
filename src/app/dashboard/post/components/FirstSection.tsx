  ...
  return (
    <section>
      ...
      <div className="flex justify-between items-center gap-5">
        <div className="bg-[#4781EB] h-96 basis-2/4 shadow-[0_10px_40px_0px_rgba(0,0,0,0.15)]"></div>
        <div className="flex flex-col gap-3 h-96 basis-2/4">
          <div className="bg-[#4781EB] basis-1/3 shadow-[0_10px_40px_0px_rgba(0,0,0,0.15)]"></div>
          <div className="bg-[#4781EB] basis-1/3 shadow-[0_10px_40px_0px_rgba(0,0,0,0.15)]"></div>
          <div className="bg-[#4781EB] basis-1/3 shadow-[0_10px_40px_0px_rgba(0,0,0,0.15)]"></div>
        </div>
      </div>
